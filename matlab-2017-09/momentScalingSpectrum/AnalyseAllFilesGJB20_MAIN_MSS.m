function [DiF] = AnalyseAllFilesGJB20_MAIN_MSS(TRtotal,pixelSize,Dboundary) %Description: Script to analyze the TRtotal matrix.
...
bars=30;
[DiF] = msddGJB20_MSS(TRlength, pixelSize, Tau, Fit, Dboundary, interactive3 ,bigorsmall, addformerhist,genoutput, bars);
...
% 
% 
% plotfit=2; % 0=no fit through MSD, 1=straight line, 2=t^alpha, 3=directed, 4=confined.  %%Puedes modificarlo!
% 
% 
% AvarD_MSD=MeanMSDanalysisGJB18(TRmobile,Tau,selectlength,truncateMSD,interactiveMSD,plotlength,plotfit)
